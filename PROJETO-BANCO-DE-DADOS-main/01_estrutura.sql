...
-- 3. profissional (médicos, residentes e preceptores)
...
-- 6. unidade(local do atendimento)
...
-- 8. atendimento(a consulta em si)
...
-- 9. procedimento (catálogo do hospital)
...
-- 10. procedimento realizado (o que foi feito na consulta)
